...
& = P\left(\widehat p - 1.96\sqrt{\frac{p(1-p)}{n}}\leq p \leq \widehat p + 1.96\sqrt{\frac{p(1-p)}{n}}\right), 
\end{aligned}
$$ 
em que $\widehat p = \frac{S_n}{n}$ e a margem de erro é $1.96\sqrt{\frac{p(1-p)}{n}}$.
...
Portanto, $0.95 \leq P\left(\widehat p - 1.96\sqrt{\frac{1}{4n}} \leq p \leq \widehat p + 1.96\sqrt{\frac{1}{4n}}\right)$. 
...
1) O intervalo de confiança de $95\%$ é dado por: $$ \mbox{IC}(p;0.95) = 0.333 \pm 1.96 \sqrt{\frac{0.333 \cdot 0.667}{300}} = 0.333 \pm 0.053$$ Ou simplesmente $(0.280 ; 0.387)$. 
